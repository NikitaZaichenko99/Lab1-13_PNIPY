...
class IndexError :public Error //ошибка в индексе множества
{
protected:
	string msg;
public:
...
class SizeError :public Error //ошибка в размере Множества
{
protected:
	string msg;
public:
...
class EmptySizeError :public SizeError //пустое множество
{
protected:
	string msg_;
public:
